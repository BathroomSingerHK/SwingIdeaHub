...
CSV_PATH = os.path.join(BASE_DIR, 'thematic_basket.csv')

# 1. 讀取 CSV 檔案
print(f"Reading CSV from: {CSV_PATH}")
if not os.path.exists(CSV_PATH):
    # 嘗試相容舊路徑
    if os.path.exists('thematic_basket.csv'):
        CSV_PATH = 'thematic_basket.csv'
    else:
